(function ($) {
     ...
     */
    Drupal.theme.prototype.rtaExampleButton = function (path, title) {
     ...
     */
    Drupal.behaviors.rtaExampleBehavior = {
        attach: function (context, settings) {
            ...
            $('.some-selector', context).once('foo', function () {
                ...
                var $anchor = Drupal.theme('rtaExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
            ...
            if( $('.playbutton').length) {
                ...
                $(".playbutton").click(function(){
                    if( $(this).hasClass('pauseme') ){
                        ...
                        var srcurl = $(this).find('.recordfile').html();
                        // console.log(srcurl);
                        snd = new Audio(srcurl);
                        snd.play();
            ...
            if( $('.front').length) {
                $('.blocker.video').click(function () {
                   $('.overlay.hidden').show();
                });
                $('.exitbutton').click(function () {
					console.log("Click");
                    $('.overlay.hidden').hide();
					$('.overlay .videoholder iframe').remove();
					$('.overlay .videoholder').append('<iframe src="https://www.youtube.com/embed/Wf74Q1BGX68?rel=0" allow="autoplay; encrypted-media" allowfullscreen="" width="560" height="315" frameborder="0"></iframe>');
                });
            }
