...
const config = {
  ...
  excludePatterns: [
    ...
    "live-site-links-functional-index.html",
    "live-site-links-including-visible-URLS-index.html",
  ...
  selectors: {
    ...
    title: ["#section-title", "#primary > h2:nth-child(1)", "#item > h2", "title", "h1", ".post-title", ".entry-title"],
...
function extractContentFromHtml(filePath) {
  try {
    ...
    //get more descriptive title to limit duplicate results
