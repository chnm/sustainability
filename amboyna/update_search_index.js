...
const config = {
  ...
  excludePatterns: [
    ...
    "wp-includes/",
    "category/",
    "image_captcha?sid=77118&ts=1646873487",
    "image_captcha?sid=77119&ts=1646873997",
    "?page=",
  ],
  ...
  selectors: {
    ...
    title: ["title", "h1", ".post-title", ".entry-title", "div.panel-pane.pane-node-title > h1"],
    ...
    remove: [
      ...
      ".field__label",
      ".breadcrumb",
      "body > div.l-page.has-no-sidebars > div > div > div > div > div > div > div > span > div.srcanalysis > h2 > span",
    ],
  },
};
