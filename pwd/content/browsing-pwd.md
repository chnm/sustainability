...
Names are primarily associated with the authors and recipients of the documents in the *Papers*. The Documents are all of the documents in the collection, including those which do not have an available transcription or image.

---

### Browse Names

Click on Names in the header of the Collection page to browse by name. By default, the names display in the order the records were created for the collection. You can change the order in which they display using the two drop-down menus on the left hand side of the screen above the list of names.

In the first drop-down, select from: Title (name); Identifier (a number assigned by the system); and (date) Created. In the second drop-down, set the sort to either Ascending or Descending. Click Sort to apply your changes.
...
Click on Documents in the header of the Collection page to browse by name. By default, the documents display in the order the records were created for the collection. You can change the order in which they display using the two drop-down menus on the left hand side of the screen above the list of documents.
