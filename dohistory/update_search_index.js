...
const config = {
  ...
  excludeDirs: ["node_modules", ".git", ".github", "category", "misc", "modules", "node", "sites"],
  ...
  excludePatterns: [
    ...
    "feed/",
    "?page=",
    "diary365excerpts.txt",
    "diary365excerpts.txt.old",
    "search/",
    "sitemap.html",
    "search_not.html",
    "home.archive",
    "googleecd11242cae80fd8.html",
    "two_stories/images/",
    "two_stories/media/",
    "timeline/images/",
    "ssicount/",
  ...
  selectors: {
    ...
    title: ["body > table:nth-child(3) > tbody > tr > td > table:nth-child(1) > tbody > tr > td > font > b", "title", "h1", ".post-title", ".entry-title"],
    ...
    remove: [
      ...
      ".field__label",
      ".breadcrumb",
      "body > table:nth-child(11) > tbody > tr > td > table > tbody",
      'body > table:nth-child(6) > tbody > tr:nth-child(1) > td[width="105"][rowspan="3"][bgcolor="#333366"]',
      'body > table:nth-child(6) > tbody > tr:nth-child(1) > td[align="center"][bgcolor="#333366"]',
      "body > table:nth-child(3) > tbody > tr:nth-child(1) > td:nth-child(2) > table > tbody > tr > td:nth-child(2)",
      'body > table:nth-child(3) > tbody > tr:nth-child(4) > td[width="66"][rowspan="5"]',
      "body > table:nth-child(3) > tbody > tr:nth-child(7) > td > form",
      "noscript",
    ],
  },
};
...
function extractContentFromHtml(filePath) {
  try {
    ...
    let title = "";
    let addition = ["body > table:nth-child(6) > tbody > tr:first-child > td:nth-child(2) :is(font:nth-child(5), font, nobr > font, nobr) > b",
      "body > table > tbody > tr > td:nth-child(3) > table:nth-child(5) > tbody > tr:nth-child(1) > td:nth-child(2) > p > font > b",
      "body > table > tbody > tr > td:nth-child(3) > table:nth-child(3) > tbody > tr > td > table > tbody > tr:nth-child(1) > td > font > b",
      "body > p:nth-child(2) > table:nth-child(3) > tbody > tr > td:nth-child(2) > p:nth-child(1) > font > b"
    ]
    ...
    for (const x of addition) {
      const addText = $(x).first().text().trim();
      if (addText) {
        title = title + " " + addText;
        break;
      }
    ...
    const tempPath = relativePath.replace(/\?/g, "%3F");
    const encodedRelativePath = "/" + tempPath
